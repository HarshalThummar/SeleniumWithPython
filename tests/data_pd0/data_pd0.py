...
# -*- coding: utf-8 -*-
"""
Created on Thu May 25 00:26:09 2017
...
for i in range(len(count)-1):
    ...
    name.send_keys(new_df_pd2.ix[int(index),'main_title'])
    
    description = driver.find_element_by_css_selector('#id_description')
    description.send_keys(new_df_pd2.ix[int(index),'description'])
    
    price = driver.find_element_by_css_selector('#id_price')
    price.send_keys(str(new_df_pd2.ix[int(index),'standard_price']))
...
#    category_pendant.click()
    ...
    for j in range(3):
        ...
        for k in range(int(count[i+1])):
            if new_df_pd2.ix[index+k,'sub_category'] == 'Amethyst':
                g = 13
            if new_df_pd2.ix[index+k,'sub_category'] == 'Aquamarine':
                g = 12
            if new_df_pd2.ix[index+k,'sub_category'] == 'Blue Topaz':
                g = 11
            if new_df_pd2.ix[index+k,'sub_category'] == 'Green Amethyst':
                g = 9
            if new_df_pd2.ix[index+k,'sub_category'] == 'Lab Created Emerald'or new_df_pd2.ix[index+k,'sub_category'] == 'Emerald' :
                g = 7
            if new_df_pd2.ix[index+k,'sub_category'] == 'Lab Created Ruby'or new_df_pd2.ix[index+k,'sub_category'] == 'Ruby':
                g = 6
            if new_df_pd2.ix[index+k,'sub_category'] == 'Lab Created Sapphire' or new_df_pd2.ix[index+k,'sub_category'] == 'Sapphire':
                g = 5
            if new_df_pd2.ix[index+k,'sub_category'] == 'Peridot':
                g = 4
            if new_df_pd2.ix[index+k,'sub_category'] == 'Pink Topaz':
                g = 3
            if new_df_pd2.ix[index+k,'sub_category'] == 'Citrine':
                g = 10
            if new_df_pd2.ix[index+k,'sub_category'] == 'Smokey Quartz':
                g = 2
            if new_df_pd2.ix[index+k,'sub_category'] == 'Garnet':
                g = 8
            if new_df_pd2.ix[index+k,'sub_category'] == 'Tanzanite':
                g = 14
            if new_df_pd2.ix[index+k,'sub_category'] == 'Olap':
                g = 15
...
#            variants.click()
            ...
            variant_name.send_keys(new_df_pd2.ix[int(index+k),2])
            ################## DIAMOND
            ...
            if x==(-3):
                ...
                driver.find_element_by_xpath('/html/body/main/div/div/div[1]/div/form/div[1]/div/div[1]/div[4]/div/div/ul/li['+str(5)+']').click()
                
            sku = driver.find_element_by_css_selector('#id_sku')
            sku.send_keys(new_df_pd2.ix[int(index+k),x])
            
            ############## Price
            price = driver.find_element_by_css_selector('#id_price_override')
            price.send_keys(str(new_df_pd2.ix[int(index+k),4]))
